...
// LiquidCrystal stuuf aaded to work with a 4 x 20 character display interfaced with I2C.
...
// Separately, an HTML page written to use tinker style cloud commands or local GET commands
